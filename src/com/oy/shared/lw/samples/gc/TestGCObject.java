...
public class TestGCObject {
	...
	static ObjectLifetimeMonitor monitor = new ObjectLifetimeMonitor(
		TestGCObject.class, "TestObject", 
		"This monitor shows how instances of TestObject are created and freed."
	); 
