...
package com.oy.shared.lw.samples.graph.modified; 
...
class GraphPanel extends Panel
	...
	TaskExecutionMonitor mouseMon = new TaskExecutionMonitor(Graph.class, "MOUSE DRAG", "Monitors mouse activity.");
	SimpleGaugeMonitor stressMon = new SimpleGaugeMonitor(Graph.class, "STRESS", "Monitors stress in the graph.");
...
public class Graph extends Applet implements ActionListener, ItemListener {
	...
	String edges = "joe-food,joe-dog,joe-tea,joe-cat,joe-table,table-plate/50,plate-food/30,food-mouse/100,food-dog/100,mouse-cat/150,table-cup/30,cup-tea/30,dog-cat/80,cup-spoon/50,plate-fork,dog-flea1,dog-flea2,flea1-flea2/20,plate-knife";
